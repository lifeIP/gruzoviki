...
function Profile_Manager() {
    ...
    return (
        <Center>
            ...
            <Card sx={{ width: "65vw", height: "35vh", display: 'flex', borderRadius: "35px", alignItems: 'center', justifyContent: 'center', backgroundColor: "#F3F3F3" }}>
                <CardMedia
                    sx={{ marginLeft: "1.5vw", maxWidth: "30vh", maxHeight: "30vh", }}
                    component="img"
                    alt="user"
            ...
            {
            orderData.map((data) => (
                <Card sx={{ width: "65vw", height: "15vh", display: 'flex', borderRadius: "35px", marginBottom: "1.5vh", display: 'flex', alignItems: 'center', justifyContent: 'center', backgroundColor: "#F3F3F3" }}>
                    <CardContent sx={{ marginLeft: '1.5vw', width: "25hw" }}>
                        <Typography variant="body2" color="text.secondary">Номер заказа: {data.id}</Typography>
                    </CardContent>
                    <CardContent sx={{ marginLeft: '1.5vw', width: "25hw" }}>
